...
SECRET_KEY = 'django-insecure-f_53xy=(=21w_dft%-^6m#mveetpsm59d80&b23v96lv3v&6@)'
...
# Переменные окружения для API Telegram Bot.
# https://core.telegram.org/bots/api

TELEGRAM_API_TOKEN = os.getenv('TG_TOKEN')
TELEGRAM_API_URL = os.getenv('TG_URL')
...
CELERY_BEAT_SCHEDULE = {
    'send_daily_habit': {
        'task': 'habits.tasks.send_daily_habit_messages',
        'schedule': crontab(minute="*/1"),
    },
    'send_weekly_habit': {
        'task': 'habits.tasks.send_weekly_habit_messages',
        'schedule': crontab(minute="*/1"),
    },
}
